...
export default class extends Controller {
  ...
  goFetch() {
    ...
    fetch(href).then(response => response.text()).then(html => {
      ...
      let newElements = fragment.querySelector('[data-controller~="' + this.controllerNameValue + '"]').children;
      document.querySelector('[data-controller~="' + this.controllerNameValue + '"]').append(...newElements);
