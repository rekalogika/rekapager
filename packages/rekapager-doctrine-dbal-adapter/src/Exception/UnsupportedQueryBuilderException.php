...
class UnsupportedQueryBuilderException extends UnexpectedValueException
{
    ...
    {
        parent::__construct('Unsupported QueryBuilder. The supplied QueryBuilder must not have a "first result" or "max results" parameters by calling "setFirstResult()" or "setMaxResults()".');
    }
}
