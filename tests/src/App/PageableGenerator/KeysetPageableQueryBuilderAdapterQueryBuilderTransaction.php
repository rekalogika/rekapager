 ...
 */
class KeysetPageableQueryBuilderAdapterQueryBuilderTransaction implements PageableGeneratorInterface
{
    ...
    {
        return 'keysetpageable-querybuilderadapter-querybuilder-transaction';
    }

    #[\Override]
    public function getTitle(): string
    {
        return 'KeysetPageable - ORM QueryBuilderAdapter (approximated) - ORM QueryBuilder (with transaction)';
    }
