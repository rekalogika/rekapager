 ...
 */
class OffsetPageableDBALQueryBuilderAdapterDBALQueryBuilder implements PageableGeneratorInterface
{
    ...
    {
        return 'offsetpageable-dbalquerybuilderadapter-dbalquerybuilder';
    }

    #[\Override]
    public function getTitle(): string
    {
        return 'OffsetPageable - DBAL QueryBuilderAdapter - DBAL QueryBuilder';
    }
